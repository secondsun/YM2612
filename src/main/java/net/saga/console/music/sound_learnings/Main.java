...
import net.saga.console.music.sound_learnings.util.Audio;
...
public final class Main {
    ...
    public static void main(String args[]) throws InterruptedException {
        ...
        chip.writeRegister(YM2612.LFO_REG, 0b1110);
        final Audio a = new Audio.AudioBuilder().setChip(chip).build();
        Thread t = new Thread(() -> {
            while (running) {
                a.play();
            }
